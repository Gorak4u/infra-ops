...
# Disable swap
swapoff -a
# Fixed: Use simpler sed command to avoid JS octal escape issues with backreferences in template literals
...
/opt/puppetlabs/bin/puppet apply /opt/omnicloud/clusters//puppet/manifest.pp
