...
echo "[Bootstrap] Starting node provisioning for cluster: ggonda-test-cassandra-cluster..."
...
/opt/puppetlabs/bin/puppet apply /opt/omnicloud/clusters/ggonda-test-cassandra-cluster/puppet/manifest.pp
